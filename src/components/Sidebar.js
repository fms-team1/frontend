...
export default function Sidebar(props) {
    ...
    return (
        <div className={props.state ? 'open sidebar' : 'sidebar'} onClick={() => media ? props.setState(!props.state) : ''}>
            <div className={props.state ? 'open sidebar__whole' : 'sidebar__whole'}>
                ...
                <nav className='navbar'>
                    ...
                    >
                        ...
                        <div className="navbar__link-text" onClick={() => media ? props.setState(!props.state) : ''}>Главная</div>
                    </NavLink>
                    <NavLink
                        activeClassName="navbar__link--active"
                        className="navbar__link"
                    ...
                    <div className="navbar__link-text" onClick={() => media ? props.setState(!props.state) : ''}>Журнал</div>
                    </NavLink>
                    <NavLink
                        activeClassName="navbar__link--active"
                        className="navbar__link"
                        ...
                        <div className="navbar__link-text" onClick={() => media ? props.setState(!props.state) : ''}>Аналитика</div>
                    </NavLink>
                    <NavLink
                        activeClassName="navbar__link--active"
                        className="navbar__link"
                        ...
                        <div className="navbar__link-text" onClick={() => media ? props.setState(!props.state) : ''}>Пользователи</div>
                    </NavLink>
                </nav>
            </div>
        </div>
